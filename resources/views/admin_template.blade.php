            ...
            <div class="sidebar">
                ...
                <nav class="mt-2" id="myNav">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{route('form2fa')}}" class="nav-link navi">
                        ...
                        <li class="nav-item">
                            <a href="{{route('request_price_order')}}" class="nav-link navi">
                                <i class="nav-icon fas fa-shopping-cart"></i>
                                <p>
                                    Pesanan
                                </p>
                        ...
                        <li class="nav-item">
                            <a href="{{route('company_shop')}}" class="nav-link navi">
