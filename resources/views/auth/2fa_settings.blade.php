    ...
    <div class="row">
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Amankan akun anda dengan two factor authentication</p>
                    <ul>
                        <li>1. Silahkan download Google Authenticator pada App Store atau PlayStore di device anda</li>
                        <li>2. Klik tanda + pada aplikasi GA anda lalu scan barcode yang ada di layar anda</li>
                        <li>3. Lalu masukan kode yang ada di aplikasi GA anda</li>
                    </ul>
                    @if (session('error'))
