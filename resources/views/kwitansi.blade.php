...
<body>
    ...
    <table width="100%" style="border: 1px solid;">
        <tr>
            <td style="text-align: center; font-size:20px;"><strong>Kwitansi</td>
    ...
    <table id="tableku" width="100%">
        <tr>
            <td style="text-align: left;">Kepada Yth.
                <br>
                {{$order->User->name}}
                <br>
                ...
                <br>
                <br>
                Sudah Terima dari : {{$order->User->name}}
                Uang Sebesar: {{$payment->total_price}}
            </td>
            <td style="text-align: right;">No: INV/MS/{{$order->order_number}}</td>
        </tr>
    ...
    <table id="tableku" width="100%">
        <tr>
            ...
            <td style="text-align: right;">
                ...
                NPWP:----<br>
                BANK: ---<br>
                Aatas Nama:CV MANYAR SEWU
                <br> No. Rekening: 0000-0000-0000
            </td>
        </tr>
