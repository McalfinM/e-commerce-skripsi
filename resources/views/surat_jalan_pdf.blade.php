...
<body>
    ...
    <table width="100%" style="border: 1px solid;">
        <tr>
            <td style="text-align: center; font-size:20px;"><strong>Surat Jalan</td>
    ...
    <table id="tableku" width="100%">
        ...
        <tbody>
            ...
            @endphp
            <tr>
                <td id="tableku" scope="row">{{$number}}</td>
                <td id="tableku">{{$datas->product->name}}</td>
                <td id="tableku" align="center">{{$datas->quantity}} {{$datas->volume}}</td>
    ...
    <footer class="footer">
        <table width="100%">
            <tr>
                <td style="text-align: left;">CV MANYAR SEWU
