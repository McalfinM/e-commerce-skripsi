...
<body>
    ...
    <table width="100%" style="border: 1px solid;">
        <tr>
            <td style="text-align: center; font-size:20px;"><strong>Invoice</td>
    ...
    <table width="100%" style="border: 1px solid;">
        <tr>
            <td style="text-align: left; font-size:10px;">Kpd Yth<br>
                {{$order->User->username}}<br>
                {{$order->address ?? 'alamat perusahaan'}}
                <br>
                bersama ini kami lampirkan tagihan untuk barang - barang berikut:
            </td>
            <td style="text-align: right;">
                No: INV/MS/{{$order->order_number.'/'.date('Y')}}<br>
                Tanggal: {{date('d-m-Y', strtotime($order->created_at));}}
            </td>
        </tr>
        ...
        <thead">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td id="tableku">{{$datas->product->name}}</td>
                    <td id="tableku" align="right">{{$datas->quantity}} {{$datas->volume}}</td>
    ...
    <footer class="footer">
        ...
        <table width="100%">
            <tr>
                <td style="text-align: left;">Irwan Y.
