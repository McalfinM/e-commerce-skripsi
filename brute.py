...
CHROME_DVR_DIR = '/usr/local/bin/chromedriver'
...
banner = color.BOLD + color.RED +'''
 Brute Force Testing Example                  '''.format(color.RED, color.CWHITE,color.RED,color.GREEN,color.RED, color.CWHITE,color.RED,color.GREEN,color.RED, color.CWHITE,color.RED,color.GREEN)
